...
for i = 1:numel(a)
    if a(i) == 'w'
        ...
        windows = [0, 0, 0, 1.6, 1, 1, 0, 0, 1, 0;     %kitchen
                   ...
                   0, 0, 0, 3.5, 1.2, 1, 0, 0, 5, 1;   %bedroom1
                   0, 0, 0, 2.8, 1.2, 1, 0, 0, 6, 1;   %bedroom2
    ...
    elseif a(i) == 'p'
        ...
        pL = 1053/1000;
        pH = 1590/1000;
        solarPanel = [pL, pH, 21, 0.197, cos(41*pi/180), 0, sin(41*pi/180)];          
        
        solarPanel(:,5:7) = solarPanel(:,5:7)*rotz(ang);

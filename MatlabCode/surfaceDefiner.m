...
for i = 1:numel(a)
    if a(i) == 'w'
        ...
        windows = [0, 0, 0, 1.6, 1, 1, 0, 0, 1;     %kitchen
                   ...
                   0, 0, 0, 0.8, 1, 0, 1, 0         %bathroom ground
    ...
    elseif a(i) == 's'
        ...
        structure = [0, 0, 0, 18, 5.7, 70.16, 0, 1, 0, cellulose, 0.3;          %Exterior Wall South
                     0, 0, 0, 7, 5.7, 40.2, 1, 0, 0, cellulose, 0.3;            %Exterior Wall West
                     0, 0, 0, 18, 5.7, 102.7, 0, -1, 0, cellulose, 0.3;         %Exterior Wall North
                     0, 0, 0, 7, 5.7, 40.2, -1, 0, 0, cellulose, 0.3;           %Exterior Wall East
